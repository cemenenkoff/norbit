...
end_time = 7*365.26*24*3600 # Define the end time in seconds (e.g. 100 years).
...
m_ = [m0, m1, m2, m3, m4] #Combine the masses into an ordered list.
...
"""
Purpose:
    Given a separate database with mass and initial conditions data for a
    certain number of bodies, orbit() calculates the trajectories of a subset
    of bodies database of size N.
Inputs:
