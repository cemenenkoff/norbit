...
ax5.plot(r[:, mf, 0], p[:, mf, 0], color=c_[mf], label=labs[mf], alpha=a_)
...
ax6.plot(r[:, mf, 1], p[:, mf, 1], color=c_[mf], label=labs[mf], alpha=a_)
...
ax7.plot(r[:, mf, 2], p[:, mf, 2], color=c_[mf], label=labs[mf], alpha=a_)
plt.savefig('fig7', bbox_inches='tight')

skip = int(0.5*((tf_-t0_)/dt_))
...
ax8.plot(r[:, mf, 0], KE[:, mf, 0], color=c_[mf], label=labs[mf], alpha=a_)
...
ax9.plot(r[:, mf, 1], KE[:, mf, 1], color=c_[mf], label=labs[mf], alpha=a_)
...
ax10.plot(r[skip:, mf, 2], KE[skip:, mf, 2], color=c_[mf], label=labs[mf], alpha=a_)
